        ...
        (jsonResult) => {
         ...
         //use array for each method 
            ...
            const concreteRoseId = document.getElementById('concreteRoseId');
                        ...
                        //concreteRoseId.innerHTML = book1[1].description;

            //trying to create a getElementbyClass so I can display the descriptions
            const concreteRoseClass = document.getElementsByClassName('concreteRose');
                        concreteRoseClass.innerHTML = book1.description;
